  ...
  <div class="innerRowBox">
   <div class="createUserBox MessageMasterMain">
    ...
    <tbody>
      ...
      <tr>
        <td>
          <form action="<?php echo base_url(); ?>auth_admin/add_message_master" method="POST" id="message">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 75%; text-align: left;">
                ...
                <tbody>
                <tr>
                  <td><input type="radio" name="language" value="0" checked="checked"><label>English</label></td>
                  <td style="padding-left:10px;"><input type="radio" name="language" value="1"><label>Hindi</label></td>
                </tr>
              </tbody>
               </table>
             </td>
          ...
          <tr>
            ...
            <td style="height: 30px; text-align: left;">
              <input name="scroll_message" id="board-message" type="text" maxlength="250" style="font-family:ARIAL;font-size:12pt;height:23px;width:95%;">  
            </td>
          </tr>
          <tr>
